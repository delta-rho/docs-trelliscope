...
<h4>Usage</h4>
<pre class="r"><code>vdbConn(path, name = NULL, autoYes = FALSE, verbose = TRUE)</code></pre>
...
<pre class="r"><code>view(name = NULL, group = NULL, state = NULL, openBrowser = TRUE,
  conn = getOption("vdbConn"), port = 8100L)</code></pre>
...
<h4>Usage</h4>
<pre class="r"><code>updateDisplay(name, ..., group = "common", conn = getOption("vdbConn"))</code></pre>
...
<p class="rd-p">Airplane data</p>

<h4>Usage</h4>
<pre class="r"><code>data(airplane)</code></pre>
